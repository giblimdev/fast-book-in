...
import { Search, Shield, X, Filter } from "lucide-react";
...
interface AccessibilityOptionFilterProps {
...
export default function AccessibilityOptionFilter({
  onFilterChange,
  initialFilters = {},
}: AccessibilityOptionFilterProps) {
  ...
  const hasActiveFilters =
    searchTerm || filters.category || filters.includeRelations;
