...
import { Search, Home, X, Filter } from "lucide-react";
...
interface RoomAmenityFilterProps {
...
export default function RoomAmenityFilter({
  onFilterChange,
  initialFilters = {},
}: RoomAmenityFilterProps) {
        ...
        <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-200">
          ...
          {filters.category && (
            <span className="inline-flex items-center gap-1 px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">
              ...
              {
                AMENITY_CATEGORIES.find((c) => c.value === filters.category)
                  ?.label
              }
              <button
